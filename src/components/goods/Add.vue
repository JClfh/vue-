<template>
  <div>
      ...
      >
        ...
        >
          ...
          <el-tab-pane label="商品内容" name="4">
            <!-- 富文本编辑器 -->
            <!-- 下载安装 cnpm install vue-quill-editor --save -->
    ...
    <el-dialog title="图片预览" :visible.sync="previewDialogVisible" width="50%" @close="picPreviewClosed">
      <img :src="picPath" alt="" class="previewImg">
    </el-dialog>
  </div>
</template>
